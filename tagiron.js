...
// console.log(`赤の数の合計数は？: ${getResponseOfQuestion(cpuCards, 0)}`);
// console.log(`[共有情報カード]数字タイルの最大の数から最小の数を引いた数は？: ${getResponseOfQuestion(cpuCards, 1)}`);
// console.log(`赤の数字タイルは何枚ある？: ${getResponseOfQuestion(cpuCards, 2)}`);
// console.log(`大きい方から３枚の合計数は？: ${getResponseOfQuestion(cpuCards, 3)}`);
// console.log(`同じ数字タイルのペアは何組みある？: ${getResponseOfQuestion(cpuCards, 4)}`);
// console.log(`小さい方から３枚の合計数は？: ${getResponseOfQuestion(cpuCards, 5)}`);
// console.log(`連番になっているタイルはどこ？: ${getResponseOfQuestion(cpuCards, 6)}`);
// console.log(`5はどこ？: ${getResponseOfQuestion(cpuCards, 7)}`);
// console.log(`8または9はどこ？（どちらかひとつ選択）: ${getResponseOfQuestion(cpuCards, 8)}`);
// console.log(`青の数の合計数は？: ${getResponseOfQuestion(cpuCards, 9)}`);
// console.log(`[共有情報カード]中央の数字タイルは5以上？4以下？: ${getResponseOfQuestion(cpuCards, 10)}`);
// console.log(`1または2はどこ？（どちらかひとつ選択）: ${getResponseOfQuestion(cpuCards, 11)}`);
// console.log(`青の数字タイルは何枚ある？: ${getResponseOfQuestion(cpuCards, 12)}`);
// console.log(`偶数は何枚ある？: ${getResponseOfQuestion(cpuCards, 13)}`);
// console.log(`奇数は何枚ある？: ${getResponseOfQuestion(cpuCards, 14)}`);
// console.log(`連続して隣り合っている同じ色はどこ？: ${getResponseOfQuestion(cpuCards, 15)}`);
// console.log(`[共有情報カード]タイルすべての合計数は？: ${getResponseOfQuestion(cpuCards, 16)}`);
// console.log(`3または4はどこ？（どちらかひとつ選択）: ${getResponseOfQuestion(cpuCards, 17)}`);
// console.log(`6または7はどこ？（どちらかひとつ選択）: ${getResponseOfQuestion(cpuCards, 18)}`);
// console.log(`0はどこ？: ${getResponseOfQuestion(cpuCards, 19)}`);
// console.log(`中央の３枚の合計数は？: ${getResponseOfQuestion(cpuCards, 20)}`);

// console.log(`赤の数の合計数は？: ${totalNumbersOfRed(cpuCards)}`);
// console.log(`[共有情報カード]数字タイルの最大の数から最小の数を引いた数は？: ${getMaxMinDifference(cpuCards)}`);
// console.log(`赤の数字タイルは何枚ある？: ${countTilesOfRed(cpuCards)}`);
// console.log(`大きい方から３枚の合計数は？: ${totalTop3Numbers(cpuCards)}`);
// console.log(`同じ数字タイルのペアは何組みある？: ${countPairsOfSameNumber(cpuCards)}`);
// console.log(`小さい方から３枚の合計数は？: ${totalBottom3Numbers(cpuCards)}`);
// console.log(`連番になっているタイルはどこ？: ${findContinuousTiles(cpuCards)}`);
// console.log(`5はどこ？: ${findTile5(cpuCards)}`);
// console.log(`8または9はどこ？（どちらかひとつ選択）: ${findTile8Or9(cpuCards)}`);
// console.log(`青の数の合計数は？: ${totalNumbersOfBlue(cpuCards)}`);
// console.log(`[共有情報カード]中央の数字タイルは5以上？4以下？: ${checkCentralNumberRange(cpuCards)}`);
// console.log(`1または2はどこ？（どちらかひとつ選択）: ${findTile1Or2(cpuCards)}`);
// console.log(`青の数字タイルは何枚ある？: ${countTilesOfBlue(cpuCards)}`);
// console.log(`偶数は何枚ある？: ${countEvenNumbers(cpuCards)}`);
// console.log(`奇数は何枚ある？: ${countOddNumbers(cpuCards)}`);
// console.log(`連続して隣り合っている同じ色はどこ？: ${findContinuousSameColor(cpuCards)}`);
// console.log(`[共有情報カード]タイルすべての合計数は？: ${totalNumbersOfAll(cpuCards)}`);
// console.log(`3または4はどこ？（どちらかひとつ選択）: ${findTile3Or4(cpuCards)}`);
// console.log(`6または7はどこ？（どちらかひとつ選択）: ${findTile6Or7(cpuCards)}`);
// console.log(`0はどこ？: ${findTile0(cpuCards)}`);
// console.log(`中央の３枚の合計数は？: ${totalCentral3Numbers(cpuCards)}`);
